...
try:
    ...
    for workspace in "/home/debian/ros_catkin_ws/install_isolated".split(';'):
...
code = generate_environment_script('/home/debian/ros_imu/devel/env.sh')

output_filename = '/home/debian/ros_imu/build/catkin_generated/setup_cached.sh'
