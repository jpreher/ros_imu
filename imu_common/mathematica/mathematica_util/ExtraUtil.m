...
Indentify::usage = "Indentify[str, indent:\"    \"]  indent each line of a string with a given prefix";

EnsureDirectoryExists::usage = "EnsureDirectoryExists[dir]  Like mkdir -p $dir";
...
Indentify[str_, indent_: "    "] := Module[{lines},
   lines = StringSplit[str, "\n"];
   StringImplode[Table[indent <> line, {line, lines}], "\n"]
   ];

EnsureDirectoryExists[dir_String] := Module[{pieces, cur},
