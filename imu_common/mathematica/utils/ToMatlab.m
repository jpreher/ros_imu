...
September 7, 2012
eacousineau - Added case for empty list expression, and EmptyQ[]
September 15, 2012
...
Options[WriteMatlabFunction]={Directory->".",Arguments->{},Formatter->(#&),PreStatement->"",CheckArguments->False};
...
ToMatlab[e_?EmptyQ] := foldlines["[];\n"];

(* This might be a duplicate of RulesToMatlab, but oh well *)
(* Have to override this to get EmptyQ rule to actually work *)
